                ...
                child: Column(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: _buildSecondSegment(isTabletOrMobile,context,screenSize),
                                      ),
         ...
         return Container(
           ...
           child: Column(
             ...
             children: [
               ...
               SizedBox(height: 10),
               ReusableTextWidget(
                   text: "Tools, IDEs, and Others", fontSize: ResponsiveSize.getSize(context, 24), fontWeight: FontWeight.w700),
               ...
               SizedBox(
                 ...
                 child: ListView.builder(
                   ...
                   itemBuilder: (context, index) {
                     return Container(
                       width: screenSize.width * 0.2, // Ensure items have enough width
                       margin: EdgeInsets.symmetric(horizontal: ResponsiveSize.getSize(context, 10),),
                       child: Column(
                         mainAxisAlignment: MainAxisAlignment.center,
                         crossAxisAlignment: CrossAxisAlignment.center,
                         children: [
                           ...
                           SizedBox(height: ResponsiveSize.getSize(context, 20),),
                           Expanded( // Ensures text does not overflow
                             child: Column(
                               crossAxisAlignment: CrossAxisAlignment.center,
                               children: [
                                 ReusableTextWidget(
                                   text:  homeController.toolsAndIDEs[index]['name'] ?? '',
                                 ...
                                 ReusableTextWidget(
                                   text:  homeController.toolsAndIDEs[index]['level'] ?? '',
         ...
         return Container(
           ...
           child: Column(
             children: [
               ...
               SizedBox(height: 10),
               ReusableTextWidget(
                   text: "Blogs", fontSize:ResponsiveSize.getSize(context, 24), fontWeight: FontWeight.w700),
               SizedBox(height:  ResponsiveSize.getSize(context, 50),),
               GridView.builder(
                 shrinkWrap: true,
                 physics: NeverScrollableScrollPhysics(), // Prevents nested scrolling
     ...
     return LayoutBuilder(
       builder: (context, constraints) {
         ...
         return Container(
           ...
           decoration: BoxDecoration(color: ColorConstants.primaryColor,),
           margin: EdgeInsets.only(top: ResponsiveSize.getSize(context, 40)),
           padding: EdgeInsets.only(top: ResponsiveSize.getSize(context, 40)),
           key:contactKey,
           child: Column(
             children: [
               ReusableTextWidget(text: 'Explore My', color: ColorConstants.whiteColor,fontSize: ResponsiveSize.getSize(context, 20),),
               SizedBox(height: 10),
               ReusableTextWidget(
                   text: "Blogs", fontSize:ResponsiveSize.getSize(context, 24), fontWeight: FontWeight.w700,color: ColorConstants.whiteColor,),
               SizedBox(height:  ResponsiveSize.getSize(context, 50),),
